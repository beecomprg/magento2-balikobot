...
class SaveAddressInformation implements ResolverInterface {
    ...
    public function resolve(
        ...
        [
            ...
            ShippingInformationInterface::EXTENSION_ATTRIBUTES_KEY => $extensionAttributes
        ...
        if ($extensionAttributes) {
            ...
            if (isset($extensionAttributes['balikobot_branch'])) {
                $addressInformationExtensionAttributes->setBalikobotBranch($extensionAttributes['balikobot_branch']);
            }
            $addressInformationExtensionAttributes->setBalikobotType($extensionAttributes['balikobot_type']);
            $addressInformationExtensionAttributes->setBalikobotAdditionalInfo($extensionAttributes['balikobot_additional_info']);

            $addressInformation->setExtensionAttributes($addressInformationExtensionAttributes);
        }
